...
2. Buttons components (adjust it to your style DONT NEED TO BE ROUND LIKE THIS)
Note: you can use it for bigger containers as well and other layouts.
