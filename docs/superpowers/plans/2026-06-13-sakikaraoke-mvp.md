...
- [x] Write failing tests for YouTube URL parsing, ISO duration parsing, playback expected-time math, drift correction, scheduled controls, room creation, queue mutation, host-only controls, sync state, and singer rotation.
